...
export const TimelineItem: FC<TimelineItemProps> = ({
  ...
  return (
    <div className="flex flex-wrap gap-6 min-h justify-start relative">
      {/* Date Timeline */}
      <div
        className="h-auto w-[7.5rem] flex-none break-words whitespace-pre"
...
const Body: FC<BodyProps> = ({ link, subTitle, tag }) => {
  return (
    <div className="text-secondary-foreground w-11/12 gap-3 flex items-center">
      {link ? <FiArrowUpRight /> : null}
      <p className="text-sm font-normal w-[15rem] leading-6 mt-1">{subTitle}</p>
